...
const getPost = async(req,res)=>{
    try{
        ...
        res.status(500).json({error:err.message});
        console.log("eroor in get post ",err.message);
    }
}
...
const likedUnlikePost = async(req,res)=>{
    try{
        ...
        res.status(500).json({error:err.message});
        console.log("error in liked unlike post",err.message);
    }
}
...
export {createPost,getPost,deletePost ,getFeedPosts, likedUnlikePost,replyToPost, getUserPosts};